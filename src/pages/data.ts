export const data = [
  {
    ...
    layers: {
      ...
      '6b774af9-623d-41b7-9daa-fa7f392be460': {
        ...
        props: {
          text: '<p style="font-family: Chewy; color: rgb(0, 0, 0); font-size: 42px; text-align: center; line-height: 1.4; letter-spacing: 0em;"><strong>OBIM</strong></p><p style="font-family: Chewy; color: rgb(0, 0, 0); font-size: 42px; text-align: center; line-height: 1.4; letter-spacing: 0;"><strong>DESIGN EDITOR</strong></p>',
      ...
      '812d60e6-fa51-43f6-ac5e-53a536d5a74b': {
        type: { resolvedName: 'TextLayer' },
        props: {
          text: '<p style="font-family: Oswald; color: rgb(0, 0, 0); margin-top: 20px;  font-size: 18px; text-transform: uppercase; text-align: center; line-height: 1.5; letter-spacing: 0;"><strong>CLASS: HND 2</strong></p>',
      ...
      '1e68d85b-0be1-40de-b63b-2f394ce622e2': {
        type: { resolvedName: 'TextLayer' },
        props: {
          text: '<p style="font-family: Oswald; color: rgb(0, 0, 0); font-size: 18px; text-transform: uppercase; text-align: center; line-height: 1.5; letter-spacing: 0;"><strong>PROJECT DETAILS; NAME:OBINNA ELVIS</strong></p>',
